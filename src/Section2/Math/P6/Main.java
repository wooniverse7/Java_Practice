...
public class Main {
    public static void main(String[] args) {
        int[] arr = new int[]{1, 10, 1100, 1111};
        int n = 2;
        System.out.println(newChickenRecipe2(arr, 2));
    }
    ...
    static public ArrayList<Integer[]> newChickenRecipe(int[] stuffArr, int choiceNum) {
        ...
        // 재귀
        return permutation(choiceNum, stuffArr, result);


    }

    static ArrayList<Integer[]> permutation(int num, int[] arr, ArrayList<Integer[]> rst){
    ...
    static public ArrayList<Integer[]> newChickenRecipe2(int[] stuffArr, int choiceNum) {
        ...
        return permutation2(choiceNum, new Integer[]{}, result, freshArr, visited, 0); // dfs
    }

    static public ArrayList<Integer[]> permutation2(int choiceNum, Integer[] bucket, ArrayList<Integer[]> result, ArrayList<Integer> freshArr, boolean[] visited, int depth) {
        ...
        for(int i = 0; i < freshArr.size(); i++) {
            ...
            if(!visited[i]) {
                ...
                //다시 재귀를 사용합니다.
                result = permutation2(choiceNum, concatArray, result, freshArr, visited, depth + 1);
